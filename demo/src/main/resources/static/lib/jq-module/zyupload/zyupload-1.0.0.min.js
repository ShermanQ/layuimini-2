        ...
        return this.each(function() {
            ...
            this.createHtml = function() {
                ...
                if (para.dragDrop) {
                    ...
                    // html += '							<div class="upload_image" src="zyupload/skins/images/add_img.png" style="width:expression(this.width > ' + imgWidth + " ? " + imgWidth + 'px : this.width)" />';
                    html += "						</div>";
                    html += "					</a>";
                    html += "				</div>";
                    html += "			</div>";
